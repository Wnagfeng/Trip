<template>
  <div class="detail" ref="detailRef">
    ...
    <div class="content" v-if="infos.mainPart" v-memo="[infos.mainPart]">
      ...
      <detail-facility :ref="getContentRef" :house-facility="infos.mainPart.dynamicModule.facilityModule.houseFacility"/>
      <detail-landloard :ref="getContentRef" :landlord="infos.mainPart.dynamicModule.landlordModule"/>
      <detail-comment :ref="getContentRef" :comment="infos.mainPart.dynamicModule.commentModule"/>
      <detail-notice :ref="getContentRef" :order-rules="infos.mainPart.dynamicModule.rulesModule.orderRules"/>
